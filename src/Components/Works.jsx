...
const Works = () => {
  ...
  return (
    <section className='works' id="works">
      ...
      <h2 className='works_title'><span>03.</span> The projects I have developed</h2>
      ...
      <div className="works_featuredProyect">
        <div className='featuredProyect_container'>
          ...
          <p className='featuredProyect_description'>
              ...
              Porro est, repellat consectetur labore doloremque minima similique 
              exercitationem velit quam vitae ad dolorum dolore ratione ipsam a nostrum 
              ex quis assumenda.
          </p>
        ...
        <div className='featuredProyect_img_container'>
          <a className='featuredProyect_img_link' href="">
              <img className='featuredProyect_img' src="./pokedex.jpg" alt="pokedex-img" />
          </a>
        </div>
      </div>
            ...
            <li className="otherProjects_item">
              ...
              <div className='otherProjects_container'>
                  ...
                  <p className='otherProjects_item_description'> 
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                    Culpa soluta beatae cumque ea voluptas necessitatibus modi
                    quas commodi ad? Repellendus, eum. Nemo repellat, laudantium 
                    natus laboriosam sapiente repudiandae distinctio corrupti.
                  </p>
